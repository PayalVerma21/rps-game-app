...
function finalMessage([yourScore, computerScore])
{
  if (yourScore===0)
  {
    return {'message': 'You lost<h1> &#128530;</h1>', 'color': 'red'}
  } 
  else if (yourScore===0.5)
  {
    return{'message': 'You tied<h1> &#128522;</h1>', 'color': 'yellow'}
  } 
  else
  {
    return{'message': 'You won <h1> &#128525;</h1>', 'color': 'green'}
  }
}
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage)
{
  ...
  //removing Images
   ...
   humanDiv.innerHTML = "<img src='" + rpsImageDatebase[humanImageChoice] +"' height= 150 width=150 style= 'box-shadow: 0px 10px 50px rgba(37, 233, 50, 1);'>"
